...
PLATFORM_CONFIG = {
    "instagram": {
        ...
        # Uses FACEBOOK credentials (same OAuth app, not separate Instagram app)
        ...
        "client_id": FACEBOOK_CLIENT_ID,  # Instagram uses Facebook OAuth credentials
        "client_secret": FACEBOOK_CLIENT_SECRET,  # Instagram uses Facebook OAuth credentials
    },
    "linkedin": {
