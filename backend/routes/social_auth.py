...
PLATFORM_CONFIG = {
    "instagram": {
        ...
        # Use instagram_business_* permissions (these are the ones showing "Ready for testing")
        "scopes": ["public_profile", "pages_show_list", "pages_read_engagement", "business_management", "instagram_business_basic", "instagram_business_content_publish", "instagram_business_manage_messages"],
