...
export default function CarouselMakerPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-royal-800 to-slate-900">
      ...
      <div className="border-b border-white/10 backdrop-blur-xl bg-black/20">
        <div className="max-w-7xl mx-auto px-6 py-3 sm:py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <button onClick={() => router.push("/dashboard")} className="text-base sm:text-lg md:text-xl lg:text-2xl hover:scale-110 transition">
              ←
            </button>
            <div>
      ...
      <div className="max-w-6xl mx-auto px-6 py-4 sm:py-6 md:py-8">
        {!result && (
          <div className="bg-white/5 backdrop-blur-lg rounded-xl p-4 sm:p-6 border border-white/10 mb-3 sm:mb-4 md:mb-6">
            <h2 className="text-base sm:text-lg md:text-xl font-bold text-white mb-4">Generate Carousel</h2>
            ...
            <div className="space-y-2 sm:space-y-3 md:space-y-4">
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full px-3 sm:px-4 py-2 bg-white/10 border border-white/20 rounded-lg text-white placeholder-white/50 focus:outline-none focus:border-cobalt"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 md:gap-4">
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 sm:px-4 py-2 bg-white/10 border border-white/20 rounded-lg text-white focus:outline-none focus:border-cobalt"
                  >
        ...
        {error && (
          <div className="bg-red-500/10 border border-red-500/50 rounded-xl p-3 sm:p-4 mb-3 sm:mb-4 md:mb-6">
          ...
          <div className="space-y-2 sm:space-y-3 md:space-y-4 lg:space-y-6">
            <div className="bg-white/5 backdrop-blur-lg rounded-xl p-4 sm:p-6 border border-white/10">
              ...
              <textarea
                ...
                rows={4}
                className="w-full px-3 sm:px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white focus:outline-none focus:border-cobalt resize-none font-mono text-sm"
              />
              <p className="text-xs text-gold mt-2">Optimized for Instagram engagement</p>
            </div>

            <div className="flex items-center justify-between">
              <h2 className="text-base sm:text-lg md:text-xl lg:text-2xl font-bold text-white">Edit Your Carousel</h2>
                        ...
                        <>
                          ...
                          <div className="absolute inset-0 flex flex-col items-center justify-center p-10 text-center">
                            <textarea
                              ...
                              rows={2}
                              className="text-3xl sm:text-2xl sm:text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl md:text-4xl md:text-5xl lg:text-6xl font-black text-white bg-transparent border-2 border-transparent hover:border-white/30 focus:border-white/50 focus:outline-none px-2 py-2 rounded w-full mb-4 text-center resize-none leading-none"
                              style={{
                                textShadow: '0 4px 30px rgba(0,0,0,1)',
                                fontFamily: getBrandFontFamily(),
                                fontWeight: 900,
                      ...
                      {!isFirstSlide && (
                        <div className="h-full flex flex-col justify-center items-center p-10 text-center relative">
                          ...
                          <input
                            ...
                            value={slide.title}
                            onChange={(e) => updateSlide(idx, 'title', e.target.value)}
                            className="text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl font-bold text-black bg-transparent border-2 border-transparent hover:border-gray-300 focus:border-gray-400 focus:outline-none px-3 py-2 rounded w-full mb-3 sm:mb-4 md:mb-6 text-center"
                          ...
                          <textarea
                            ...
                            className="text-base leading-relaxed text-gray-700 bg-transparent border-2 border-transparent hover:border-gray-300 focus:border-gray-400 focus:outline-none px-3 sm:px-4 py-2 rounded w-full resize-none"
